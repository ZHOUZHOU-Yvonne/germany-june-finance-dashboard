#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Complete update with merged data, 48个月 filter, and sheet filter."""
...
# ═══════════════════════════════════════════════════════
# 3. Add filter HTML and update card generation
# ═══════════════════════════════════════════════════════

# Find the brand cards section and add filters
old_section = """  // Brand cards section
  var ch='<div class="t5-sec-hdr" style="max-width:960px;margin:28px auto 16px"><div><div class="t5-sec-title">各品牌金融政策变化 <span style="display:inline-block;font-size:11px;font-weight:600;color:#5cccf5;background:rgba(92,204,245,.1);border:1px solid rgba(92,204,245,.25);padding:2px 8px;border-radius:4px;vertical-align:middle;margin-left:6px">36个月 / 20k km</span></div><div class="t5-sec-sub">Brand Financial Policy Changes · 6月 vs 5月</div></div></div>';
...
# Update card generation to include data attributes
...
print(f"Complete update saved to: {output_file}")
print("\nFeatures added:")
